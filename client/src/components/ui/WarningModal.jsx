...
function WarningModal({ onConfirm, loading, text }) {
    ...
    return (
        ...
        dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
            ...
            {isOpen && (
              ...
              flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white"
                        >
                            ✕
                        </button>
                ...
                px-5 py-2.5 text-center"
                            >
                                {loading ? <Loading_spinner /> : 'Yes, I\'m sure'}
