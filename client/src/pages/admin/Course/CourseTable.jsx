            ...
            <table className="w-full table-auto border-collapse border border-gray-300">
                <thead>
                    <tr className="bg-gray-100">
                        <th className="w-2/5 border border-gray-300 px-4 py-2">Course Title</th>
                        <th className="w-1/5 border border-gray-300 px-4 py-2">Price</th>
                        <th className="w-1/5 border border-gray-300 px-4 py-2">Status</th>
                        <th className="w-1/5 border border-gray-300 px-4 py-2">Action</th>
                    </tr>
                </thead>
                <tbody>
